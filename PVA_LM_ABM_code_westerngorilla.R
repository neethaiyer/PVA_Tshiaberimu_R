...
## Initial parameters: survivorship, fertility, and weaning age: choose either WLG or MTN data
...
n_pyramid <- n_wlg ## n_wlg or n_mtn
...
## Load the appropriate csv file for reintroduction scenarios:
...
### test below for appropriate alpha for 1% and 2% growth rates
nyears <- 20
timeunit <- 1/12
nruns <-1
